...
int CTIRegistryListNames(const char* tag, OUT size_t* ret_size, OUT const char*** ret_names) {
...
int CTIPackedFuncCall(const void* handle, size_t num_args, const unsigned* type_codes, const packedvalue_handle* values,
